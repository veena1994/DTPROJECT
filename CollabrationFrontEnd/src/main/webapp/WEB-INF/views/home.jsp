		...
		<div id="page-wrapper">
				...
				<header id="header">
					...
					<nav id="nav">
						<ul>
							...
							<li><a href="elements.html">EVENT</a></li>
			...
			<!-- One -->
				<section id="one" class="spotlight style1 bottom">
					<span class="image fit main"><img src="<c:url value="/resources/images/pic02.jpg"/>"  /></span>
					<div class="content">
						<div class="container">
							<div class="row">
			...
			<!-- Two -->
				<section id="two" class="spotlight style2 right">
					<span class="image fit main"><img src="<c:url value="/resources/images/pic03.jpg"/>" /></span>
					<div class="content">
						<header>
			...
			<!-- Three -->
				<section id="three" class="spotlight style3 left">
					<span class="image fit main bottom"><img src="<c:url value="/resources/images/pic04.jpg"/>"  /></span>
					<div class="content">
						<header>
